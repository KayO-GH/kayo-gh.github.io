...
Used multilingual embeddings to build a RAG tool for running semantic searches across multiple documents in order to answer questions based on the said documents with compatibility for 100+ languages.  
